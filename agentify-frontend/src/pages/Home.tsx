        ...
        <div>
          ...
          >
            ...
            <button
              ...
              className={`w-8 h-8 p-1 rounded-md hover:bg-agentify-bg-gray
          ...
          <nav className="mt-4 space-y-2">
            ...
            <button
              aria-label="agents"
              title="agents"
              className={`w-9/10 flex items-center m-auto ${
          ...
          {showSidebar && (
            <div className="mt-10 px-6 transition-opacity duration-200">
              <h4 className="text-sm font-semibold text-agentify-dark mb-2">
